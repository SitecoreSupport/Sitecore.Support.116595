namespace Sitecore.Support.Data.Validators.FieldValidators
{
    ...
    [Serializable]
    public class SourceValidator : Sitecore.Data.Validators.FieldValidators.SourceValidator
    {
        public SourceValidator()
        {
        }

        public SourceValidator(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
